...
exports.removeCartItem = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Error removing item from cart: ' + err.message });
  }
};
...
exports.updateCartItem = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: 'Error updating cart item: ' + err.message });
  }
};
...
exports.checkout = async (req, res) => {
  ...
  try {
    ...
    const orderResult = await pool.request()
      ...
      .query('INSERT INTO Orders (UserId, TotalAmount, OrderDate) OUTPUT INSERTED.OrderId VALUES (@UserId, @TotalAmount, GETDATE())');
